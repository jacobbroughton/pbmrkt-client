...
const Star = ({ onHover, fillType }) => {
  ...
  } else if (fillType=null || hoveredSide == null) {
    svg = (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
  ...
  return (
    <div onMouseMove={onHover} onMouseLeave={handleMouseLeave} className='star-container'>
      {svg}
    </div>
  );
};
